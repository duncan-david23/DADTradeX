...
const LogIn = () => {
  ...
  return (
    ...
    <div className='flex flex-col h-[100vh] max-w-100vw md:flex-row '>
        ...
        <div className=' px-[20px] py-[20px] pt-[90px] md:px-[90px] md:pt-[90px] h-full w-full md:w-1/2 flex justify-center '>
          <div className=' w-[250px] md:w-[350px]'>

         
          <form onSubmit={handleSubmit}>

            <h1 className='font-bold text-xl text-black md:text-3xl md:pb-[20px] py-[7px]'>Sign Up</h1>
            ...
            <div className='flex flex-col gap-2'>
              ...
              <input type="text" id='username' name='username' placeholder='Username' value={formData.username} onChange={handleChange} required={true} className='border border-purple-400 py-[7px] px-5  rounded-lg w-full'/>
            </div>
            ...
            {/* <label htmlFor="password2" className='font-semibold'>Confirm Password*</label> */}
              <input type="password" id='password2' name='password2' placeholder='confirm password' value={formData.password2} onChange={handleChange} required={true} visible className='border border-purple-400 py-[7px] px-5 rounded-lg w-full'/>
            </div>
            ...
            <button type="submit" className='w-full bg-purple-700 text-white rounded-lg py-[5px] px-[7px] mt-[20px] font-semibold hover:bg-purple-800'>Sign Up</button>
